...
set.seed(1234)
ind <- sample(1:nrow(mydata), 0.5*nrow(mydata))
train <- mydata[ind,]
test <- mydata[-ind,]
```
# Tree Classification
...
```
```{r}
#accuracy similares en train y test no overfitting#
...
# Predicciones probabilísticas en test final
