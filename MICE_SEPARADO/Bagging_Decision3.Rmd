...
modelo_base3 <- caret::train(Exited ~ .,
                         data = train,
                         method = "rf",
                         trControl = ctrl_default,tuneGrid=tuneGrid,ntree=1)
...
modelo_over3 <- caret::train(Exited ~ .,
                         data = train,
                         method = "rf",
                         trControl = ctrl_up,tuneGrid=tuneGrid,ntree=1)
...
modelo_under3 <- caret::train(Exited ~ .,
                         data = train,
                         method = "rf",
                         trControl = ctrl_down,tuneGrid=tuneGrid,ntree=1)
...
modelo_smote3 <-caret::train(Exited ~ .,
                         data = train,
                         method = "rf",
                         trControl = ctrl_SMOTE,tuneGrid=tuneGrid,ntree=500)
...
# Guardar CSV
write.csv(submission_smote, "bagging_smote_0.230_decision3.csv", row.names = FALSE)
