...
#svm_cv2<- tune.svm(Exited ~ ., data = train, kernel = "radial", cost = c(0.001, 0.01, 0.1, 1, 5, 10, 20),gamma = c(0.5, 1, #2, 3, 4, 5, 10),scale = TRUE)
...
svm_cv2_linear <- tune("svm", Exited ~ ., data = train, kernel = 'linear',
               ranges = list(cost = c(0.01, 1, 50)), scale=TRUE)
