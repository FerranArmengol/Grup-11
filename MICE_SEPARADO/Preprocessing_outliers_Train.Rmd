...
datos_decision_2 <- datos_decision_2[, -c(23,24,25,26)]
...
```
Probando en todos los modelos obteniamos resultados muy bajos, seguramente al eliminar demasiados datos.
...
datos_decision_3 <- datos_decision_3[, -c(23,24,25,26)]
