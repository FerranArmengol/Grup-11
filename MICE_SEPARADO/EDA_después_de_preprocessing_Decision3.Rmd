---
title: "EDA despues del preprocesado Decision 3"
author: "Grupo 11"
date: "2025-12-13"
...
```{r}
datos<-read.csv("datos_decision_3_sin_mahalanobis_y_lof.csv")
dim(datos)       
head(datos)       
summary(datos)   
```
...
write.csv(datos_relevantes, "datos_relevantes_Train_Decision3.csv", row.names = FALSE)
```
