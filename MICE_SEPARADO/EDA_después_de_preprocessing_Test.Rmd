---
title: "EDA despues del preprocesado Test"
author: "Grupo 11"
date: "2025-10-06"
...
```{r}
datos<-read.csv("datos_missing_Test.csv")
dim(datos)       
head(datos)       
summary(datos)   
```
...
variables_relevantes <- c("Age","Geography","IsActiveMember","Gender","Balance","NumOfProducts","EstimatedSalary","CreditScore")
variables_relevantes

datos_relevantes <- datos[, c("ID", variables_relevantes)]
write.csv(datos_relevantes, "datos_relevantes_Test.csv", row.names = FALSE)
```
