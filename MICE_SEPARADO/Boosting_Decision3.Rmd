...
```
```{r}
mydata <- read.csv("C:/Users/usuario/Downloads/datos_relevantes_Train_Decision3.csv") 
...
# Predicción con XGB
probs_submission <- predict(modelo_smote3, newdata = datos_test, type = "prob")[,"Class1"]
pred_submission <- ifelse(probs_submission > 0.325,"Yes", "No")
