...
datos_full <- read.csv("datos_relevantes.csv")
...
pred_submission <- ifelse(probs_submission > 0.315,"Yes", "No")
...
write.csv(submission, "Boosting_XGB_SMOTE_0.315_Relev.csv", row.names = FALSE)
