...
```
```{r}
mydata <- read.csv("datos_relevantes_Train_Decision2.csv") 
...
pred_submission <- ifelse(probs_submission > 0.245,"Yes", "No")
...
#write.csv(submission, "Boosting_XGB_sinBalanceo_0.245_Relev.csv", row.names = FALSE)
