...
# Reutilizamos X e idx_complete del bloque KNN (ya completo y escalado)
# Si ejecutas LOF por separado, descomenta estas dos líneas:
...
```{r}
#  Crear datasets según la estrategia 
# Mantener todo
datos_preprocesado <- read.csv("datos_missing.csv", header = TRUE, sep = ",")
cat("\n Dataset original:", nrow(datos_preprocesado), "observaciones")
```
